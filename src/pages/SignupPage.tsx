...
export function SignupPage() {
  ...
  function captureProviderSignup(provider: 'google' | 'github') {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    setError('')
    setLoading(true)
    const companyPresent = companyName.trim().length > 0
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="auth-social">
          <button type="button" className="auth-social-btn google" onClick={() => captureProviderSignup('google')}>
          ...
          <button type="button" className="auth-social-btn github" onClick={() => captureProviderSignup('github')}>
