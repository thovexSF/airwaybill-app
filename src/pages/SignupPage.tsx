...
export function SignupPage() {
  ...
  const signupSource = locationState?.from === '/demo' ? 'demo' : 'direct'
  const signupIntent = locationState?.intent
  ...
  useEffect(() => {
    ...
    posthog?.capture('signup_page_viewed', { source: signupSource, intent: signupIntent })
  }, [posthog, signupIntent, signupSource])
  ...
  function handleProviderSignup(provider: 'google' | 'github') {
    ...
    posthog?.capture('user_signed_up_with_provider', { provider, source: signupSource, intent: signupIntent })
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    posthog?.capture('user_signed_up', { method: 'email', company_name: companyName, source: signupSource, intent: signupIntent })
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-sub">
          {signupSource === 'demo' ? t('auth.signup.demoSub') : t('auth.signup.sub')}
        </p>
