...
export function SignupPage() {
  ...
  const signupSource = searchParams.get('source') || (state?.from === '/demo' ? 'demo' : 'direct')
  const signupIntent = searchParams.get('intent') || state?.intent || 'create_account'
  const isDemoHandoff = signupSource === 'demo'
  ...
  }, [posthog, signupIntent, signupSource, user])
  ...
  return (
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <p className="auth-sub">{isDemoHandoff ? t('auth.signup.demoSub') : t('auth.signup.sub')}</p>
