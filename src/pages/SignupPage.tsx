    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="auth-social">
          <button className="auth-social-btn google" onClick={() => { (window as any).clarity?.('event', 'signup_with_google'); loginWithProvider('google') }}>
          ...
          <button className="auth-social-btn github" onClick={() => { (window as any).clarity?.('event', 'signup_with_github'); loginWithProvider('github') }}>
