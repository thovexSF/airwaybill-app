    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="auth-social">
          <button className="auth-social-btn google" onClick={() => { track('signup_with_google'); loginWithProvider('google') }}>
          ...
          <button className="auth-social-btn github" onClick={() => { track('signup_with_github'); loginWithProvider('github') }}>
