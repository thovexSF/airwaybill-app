...
export function SignupPage() {
  ...
  const signupAttribution = useMemo(() => {
    ...
    return {
      ...
      source: params.get('source') ?? (state?.from ? 'demo' : 'direct'),
      intent: params.get('intent') ?? undefined,
      doc_type: params.get('doc_type') ?? undefined,
      from_path: state?.from,
    }
  }, [location.pathname, location.search, location.state])

  useEffect(() => {
    posthog?.capture('signup_page_viewed', signupAttribution)
  }, [posthog, signupAttribution])
    ...
    <div className="auth-page">
      ...
      <div className="auth-card">
        ...
        <div className="auth-social">
          <button type="button" className="auth-social-btn google" onClick={() => handleProviderSignup('google')}>
          ...
          <button type="button" className="auth-social-btn github" onClick={() => handleProviderSignup('github')}>
