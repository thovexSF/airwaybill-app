...
export function SignupPage() {
  ...
  const attribution = useMemo(() => ({ source, intent }), [source, intent])
  ...
  function handleProviderSignup(provider: 'google' | 'github') {
    ...
    posthog?.capture('user_signed_up_with_provider', { ...attribution, provider })
...
function categorizeSignupError(message: string) {
  ...
  if (lower.includes('already') || lower.includes('registered') || lower.includes('exists')) return 'existing_account'
