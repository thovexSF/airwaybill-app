const es = {
  ...
  editor: {
    ...
    zoomReset: 'Reset',
    startGuide: {
      title: 'Empieza tu primer AWB aqui',
      overlaySub: 'Escribe directamente sobre los campos del PDF y luego guarda para verlo en Documentos. Descargar PDF queda disponible cuando la vista previa este lista.',
      formSub: 'Completa los campos del formulario y luego guarda para verlo en Documentos. Descargar PDF queda disponible cuando la vista previa este lista.',
      useForm: 'Usar formulario guiado',
      example: 'Cargar un ejemplo',
      saveHint: 'Siguiente: completa los campos requeridos, guarda y descarga el PDF.',
    },
  },
  ...
  myAwbs: {
    ...
    empty: {
      ...
      cta: '+ Crear AWB',
      badge: 'Primer documento',
      firstTitle: 'Crea, guarda y descarga tu primer AWB',
      firstSub: 'Este es tu hub de documentos. Empieza con un MAWB, guardalo para encontrarlo aqui y descarga el PDF en formato IATA cuando este listo.',
      stepsLabel: 'Pasos del primer AWB',
      stepCreateTitle: 'Crear',
      stepCreateText: 'Abre el editor con un MAWB en blanco.',
      stepSaveTitle: 'Guardar',
      stepSaveText: 'Deja el documento en este hub para editarlo despues.',
      stepDownloadTitle: 'Descargar',
      stepDownloadText: 'Exporta el PDF final para tu carpeta de embarque.',
      firstCta: '+ Crear primer {{badge}}',
      settingsCta: 'Prellenar datos de empresa',
      demoCta: 'Quieres ver un ejemplo primero?',
    },
    updated: 'Actualizado',
    open: 'Abrir',
    delete: 'Eliminar',
    confirmDelete: '¿Eliminar este AWB?',
    deleteRightClick: 'Clic derecho para eliminar',
  ...
  settings: {
    ...
    loading: 'Cargando...',
    apiKeys: 'API keys (integraciones)',
    apiKeysSub: 'Crea un token y pégalo en tu sistema (p. ej. B2B). El token completo solo se muestra una vez.',
    apiKeyName: 'Nombre',
    apiKeyNamePh: 'Ej: B2B Express',
    apiKeyCreate: 'Crear token',
    apiKeyCreated: 'Copia este token ahora — no se volverá a mostrar.',
    apiKeyCopy: 'Copiar',
    apiKeyCopied: 'Copiado',
    apiKeyRevoke: 'Revocar',
    apiKeyEmpty: 'Aún no hay API keys.',
