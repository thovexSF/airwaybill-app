const es = {
  ...
  auth: {
    ...
    signup: {
      ...
      emailRequired: 'Ingresa tu email para crear una cuenta.',
      passwordMin: 'Usa al menos 6 caracteres para tu contraseña.',
      valueFreeDocs: '10 PDFs gratis/mes',
      valueNoCard: 'Sin tarjeta',
      valueDemo: 'Descarga tu demo editado',
      valueFast: 'Empieza en menos de un minuto',
      submit: 'Crear cuenta',
