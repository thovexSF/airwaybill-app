const es = {
  ...
  auth: {
    ...
    signup: {
      ...
      demoHandoff: 'Tu AWB de demo esta listo. Crea una cuenta gratis para guardar y descargar PDFs limpios.',
      valueTitle: 'Empieza con 10 PDFs de AWB gratis al mes.',
      valueBody: 'Sin tarjeta de credito. Guarda documentos, elimina el watermark de demo y vuelve a terminar despues.',
