const es = {
  ...
  feedback: {
    ...
    placeholder: 'Ej: necesito ayuda en español, el PDF no alineó o no encontré cómo guardar.',
    ...
    topics: {
      label: '¿De qué se trata? Opcional, pero ayuda a responder más rápido.',
      bug: 'Bug',
      feature: 'Pedir función',
      question: 'Pregunta / confuso',
      language: 'Ayuda en español',
    },
    errors: {
