const es = {
  ...
  feedback: {
    ...
    languageHint: 'Puedes escribir en español o inglés.',
    placeholder: 'Escribe en español o inglés: qué pasó, qué estabas intentando hacer y qué debería pasar después.',
