const es = {
  ...
  auth: {
    ...
    signup: {
      title: 'Guarda y descarga tu primer AWB',
      sub: 'Crea tu cuenta gratis para seguir editando despues de la demo.',
      ...
      microcopy: 'Sin tarjeta, sin llamada comercial. Puedes mejorar plan solo si necesitas mas volumen de AWB.',
      proof: {
        noCard: 'No necesitas tarjeta de credito para empezar.',
        downloads: 'Incluye 10 descargas PDF de AWB cada mes.',
        afterSignup: 'El siguiente paso es el editor, listo para guardar y descargar.',
      },
