const es = {
  ...
  auth: {
    ...
    signup: {
      ...
      benefits: {
        download: 'Descarga el PDF de AWB que creaste en la demo.',
        noCard: 'Sin tarjeta de credito en el plan gratis.',
        editor: 'Guarda AWBs y editalos desde cualquier navegador.',
      },
      ...
      errors: {
        emailRequired: 'Ingresa tu email para crear la cuenta.',
        emailInvalid: 'Ingresa un email valido.',
        passwordRequired: 'Crea una contraseña para continuar.',
        passwordShort: 'Usa al menos 6 caracteres para la contraseña.',
      },
    },
    forgotPassword: {
