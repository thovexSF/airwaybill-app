const es = {
  ...
  auth: {
    ...
    signup: {
      ...
      valueProp: 'Guarda borradores, reutiliza datos de empresa y descarga PDFs AWB cuando estes listo.',
      ...
      email: 'Email',
      password: 'Contraseña',
      passwordHint: 'Usa al menos 6 caracteres. No pedimos tarjeta.',
      submit: 'Crear cuenta',
