const es = {
  ...
  auth: {
    ...
    signup: {
      ...
      sub: 'Guarda tu primer AWB y descarga PDFs en menos de un minuto.',
      benefitsLabel: 'Beneficios de la cuenta gratis',
      benefits: {
        noCard: 'Sin tarjeta de credito.',
        freeDocs: '10 PDFs de documentos gratis cada mes.',
        quick: 'Crea, guarda y descarga desde cualquier navegador.',
      },
      ...
      errors: {
        missingFields: 'Agrega tu email y una contraseña para crear la cuenta.',
        invalidEmail: 'Ingresa un email valido.',
        shortPassword: 'Usa al menos 6 caracteres para tu contraseña.',
      },
    },
    forgotPassword: {
