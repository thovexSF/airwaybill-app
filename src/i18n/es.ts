const es = {
  ...
  demo: {
    bannerTitle: '¿Listo para crear tu propio Air Waybill?',
    banner: 'Empieza con un editor en blanco y descarga 10 PDFs de AWB/mes en el plan gratis.',
    createOwnCta: 'Crear mi propio AWB',
