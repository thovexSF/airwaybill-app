const es = {
  ...
  myAwbs: {
    ...
    empty: {
      ...
      sub: 'Este es tu panel de documentos. Crea un AWB, guárdalo y luego descarga el PDF cuando esté listo.',
      stepCreate: 'Crea un AWB nuevo o importa filas desde Excel.',
      stepFill: 'Completa el formulario guiado mientras se actualiza la vista IATA.',
      stepSave: 'Guarda el documento aquí y luego descarga o imprime el PDF.',
      cta: '+ Crear AWB',
      demoCta: 'Ver demo primero',
