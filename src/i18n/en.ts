const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      sub: 'Save your first AWB and unlock PDF downloads in under a minute.',
      benefitsLabel: 'Free account benefits',
      benefits: {
        noCard: 'No credit card required.',
        freeDocs: '10 free document PDFs every month.',
        quick: 'Create, save, and download from any browser.',
      },
      ...
      signIn: 'Sign in',
      errors: {
        missingFields: 'Add your email and a password to create the account.',
