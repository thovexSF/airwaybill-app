const en = {
  ...
  auth: {
    ...
    signup: {
      title: 'Save and download your first AWB',
      sub: 'Create your free account to keep editing after the demo.',
      ...
      microcopy: 'No credit card, no sales call. You can upgrade only if you need more AWB volume.',
      proof: {
        noCard: 'No credit card required to start.',
        downloads: 'Includes 10 AWB PDF downloads every month.',
        afterSignup: 'Your next step is the editor, ready to save and download.',
      },
