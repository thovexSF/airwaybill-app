const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      demoHandoff: 'Your demo AWB is ready. Create a free account to save and download clean PDFs.',
      valueTitle: 'Start with 10 free AWB PDFs/month.',
      valueBody: 'No credit card required. Save documents, remove the demo watermark, and come back to finish later.',
