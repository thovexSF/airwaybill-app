const en = {
  ...
  feedback: {
    ...
    languageHint: 'You can write in English or Spanish.',
    placeholder: 'Write in English or Spanish: what happened, what were you trying to do, and what should happen next?',
