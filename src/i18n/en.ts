const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      demoSub: 'Create your free account to download the PDF you just edited.',
      demoNote: 'Your demo showed the workflow. Sign up to save documents and download clean PDFs without the DRAFT watermark.',
      ...
      signIn: 'Sign in',
      errors: {
        required: 'Enter your email and password to create an account.',
