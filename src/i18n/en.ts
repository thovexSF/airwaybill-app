const en = {
  ...
  myAwbs: {
    ...
    empty: {
      ...
      sub: 'This is your document dashboard. Start with one AWB, save it, then download the PDF when it is ready.',
      stepCreate: 'Create a new AWB or import rows from Excel.',
      stepFill: 'Fill the guided form while the IATA-style preview updates.',
      stepSave: 'Save the document here, then download or print the PDF.',
      cta: '+ Create AWB',
      demoCta: 'See demo first',
