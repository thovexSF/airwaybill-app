const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      benefits: {
        download: 'Download the AWB PDF you created in the demo.',
        noCard: 'No credit card required for the free plan.',
        editor: 'Save AWBs and keep editing them from any browser.',
      },
      ...
      errors: {
        ...
        passwordShort: 'Use at least 6 characters for your password.',
      },
    },
    forgotPassword: {
