const en = {
  ...
  feedback: {
    ...
    placeholder: 'Example: I need help in Spanish, the PDF did not align, or I could not find how to save.',
    ...
    topics: {
      label: 'What is this about? Optional, but it helps us reply faster.',
      bug: 'Bug',
      feature: 'Feature request',
      question: 'Question / confusing',
      language: 'Spanish help',
    },
    errors: {
