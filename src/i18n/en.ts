const en = {
  ...
  auth: {
    ...
    signup: {
      ...
      valueProp: 'Save drafts, reuse company details, and download compliant AWB PDFs when you are ready.',
      ...
      email: 'Email',
      password: 'Password',
      passwordHint: 'Use at least 6 characters. No credit card required.',
